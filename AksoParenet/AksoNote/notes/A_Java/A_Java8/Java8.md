...
- **Nashorn, JavaScript 引擎** − Java 8提供了一个新的Nashorn javascript引擎，它允许我们在JVM上运行特定的javascript应用。 --- **Java 11将声明弃用Nashorn JavaScript脚本引擎，相关API和jjs工具，并在未来的版本中移除这些特性。Nashorn JavaScript引擎在Java 8中首次引入，完整实现了ECMAScript-262 5.1标准。但是随着ECMAScript语言标准的快速发展，维护Nashorn引擎变得越发挑战，因此该引擎将在Java中废弃。**
